...
//Parameters
#define WATER_INTERVAL_MILLIS 40 * 1000 //4 * 24 * 60 * 60 * 1000 //days converted to millis
#define PUMP_OPEN_MILLIS 10 * 1000//150 * 1000 //seconds converted to millis
#define FLOAT_SENSOR_DELAY_MILLIS 150
#define START_HR 0 //9
#define END_HR 23 //18
#define WATER_LIMIT_MILLIS 20 * 1000 //1 * 24 * 60 * 60 * 1000 //days converted to millis
#define MIN_SOIL_MOISTURE_WAIT_MILLIS 5 * 1000 //4 * 24 * 60 * 60 * 1000 //days converted to millis
